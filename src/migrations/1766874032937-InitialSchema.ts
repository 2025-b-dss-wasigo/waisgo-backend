...
export class InitialSchema1766874032937 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "business"."business_users" ("id" uuid NOT NULL, "email" character varying(30) NOT NULL, "alias" character varying(25) NOT NULL, "isDeleted" boolean NOT NULL DEFAULT false, "deletedAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_b5dc4a60e0ba703952bc82513e0" UNIQUE ("email"), CONSTRAINT "UQ_cc9c0da4439790d3694573768cb" UNIQUE ("alias"), CONSTRAINT "PK_c60b727065c3c87bfb00cfcc8e7" PRIMARY KEY ("id"))`);
